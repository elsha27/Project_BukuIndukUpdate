@extends('layouts.app_sneat_admin',['title' => 'Data Guru'])
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-3 mt-3">
                <div class="col-md-6">
                    <a href="/admin/guru/create" class="btn btn-primary btn">Tambah Guru</a>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->mapel }}</td>
                        <td>
                            <a href="/admin/guru/{{ $item->id }}/edit" class="btn btn-warning btn-sm ml-2">Edit</a>
                            ...
                            <a href="/admin/guru/{{ $item->id }}/show" class="btn btn-success btn-sm ml-2">Detail</a>
                            @csrf
                            @method('delete')
