@extends('layouts.app_sneat_admin', ['title' => 'Detail Data Siswa'])
@section('content')
    <div class="container">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @elseif ($siswa->status === 'Nonaktif')
                                        <span
                                            style="background-color: red; padding: 3px 8px; border-radius: 5px; display: inline-block; color: white;">
                                            {{ ucfirst($siswa->status) }}
                                        </span>
                                    @elseif ($siswa->status === 'Lulus')
                                        <span
                                            style="background-color: blue; padding: 3px 8px; border-radius: 5px; display: inline-block; color: white;">
                                            {{ ucfirst($siswa->status) }}
                                        </span>
                                    @elseif ($siswa->status === 'Pindah')
                                        <span
                                            style="background-color: orange; padding: 3px 8px; border-radius: 5px; display: inline-block; color: white;">
                                            {{ ucfirst($siswa->status) }}
                                        </span>
                                    @else
                                        {{ ucfirst($siswa->status) }}
