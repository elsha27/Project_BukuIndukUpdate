@extends('layouts.app_sneat_admin',['title' => 'Data Rombel'])
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-3 mt-3">
                <div class="col-md-6">
                    <a href="/admin/rombel/create" class="btn btn-primary btn">Tambah Rombel</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/admin/rombel/{{ $item->id }}" method="POST" class="d-inline">
                            <!-- form action sesuai dengan id yang diambil -->
                            <a href="/admin/rombel/{{ $item->id }}/show" class="btn btn-success btn-sm ml-2">Detail</a>
                            @csrf
                            @method('delete')
