          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->is('guru') ? 'active' : '' }}">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/guru/create" class="menu-link">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/siswa/create" class="menu-link">
                    <div data-i18n="Notifications">Tambah Siswa</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item {{ request()->is('rombel') ? 'active' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/rombel" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Index Rombel</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/rombel/create" class="menu-link" target="_blank">
