      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item {{ request()->is('admin/guru', 'admin/guru/create') ? 'active' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-briefcase-alt-2"></i>
                <div data-i18n="Layouts">Data Guru</div>
              </a>
            
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/guru" class="menu-link">
                    <div data-i18n="Without menu">Index Guru</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/guru/create" class="menu-link">
                    <div data-i18n="Without navbar">Tambah Guru</div>
                  </a>
                </li>
              </ul>
            </li>

            <li class="menu-item {{ request()->is('admin/siswa', 'admin/siswa/create') ? 'active' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <li class="menu-item {{ request()->is('/admin/rombel*') ? 'active' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/rombel" class="menu-link" >
                    <div data-i18n="Basic">Index Rombel</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/rombel/create" class="menu-link" >
                    <div data-i18n="Basic">Tambah Rombel</div>
                  </a>
                </li>
              </ul>
            </li>
