@extends('layouts.app_sneat_user', ['title' => 'Data Siswa'])
@section('content')
    <div class="card">
            ...
            {{-- <div class="row mb-3 mt-3">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form action="/siswa" method="post" enctype="multipart/form-data" class="d-flex">
                            @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/siswa/{{ $item->id }}" method="POST" class="d-inline">
                                    ...
                                    <a href="/user/siswa/{{ $item->id }}/show" class="btn btn-success btn-sm ml-2">Detail</a>
                                    @csrf
