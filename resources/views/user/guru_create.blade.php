@extends('layouts.app_sneat_user', ['title' => 'Tambah Guru'])
@section('content')
    <div class="card">
        <h5 class="card-header">Tambah Data Guru</h5>
        <div class="card-body">
            <form action="/user/guru" method="post" enctype="multipart/form-data" >
                @csrf
                ...
                <div class="form-group mt-1 mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" name="status_kepegawaian" id="PNS" value="PNS"
                            {{ old('status_kepegawaian') === 'PNS' ? 'checked' : '' }}>
                        <label for="PNS" class="form-check-label">PNS</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" name="status_kepegawaian" id="Non PNS" value="Non PNS"
                            {{ old('status_kepegawaian') === 'Non PNS' ? 'checked' : '' }}>
                ...
                <div class="form-group mt-1 mb-3">
                    ...
                    <input type="number" class="form-control @error('total_jtm') is-invalid @enderror" id="total_jtm"
                        name="total_jtm" value="{{ old('total_jtm') }}">
                ...
                <div class="form-group mt-1 mb-3">
                    ...
                    <input type="file" class="form-control @error('ijazah_sd') is-invalid @enderror" name="ijazah_sd">
                    <span class="text-danger">{{ $errors->first('ijazah_sd') }}</span>
                </div>
                <div class="form-group mt-1 mb-3">
                    <label for="ijazah_smp">Ijazah SMP (pdf/doc/docx)</label>
                    <input type="file" class="form-control @error('ijazah_smp') is-invalid @enderror" name="ijazah_smp">
                    <span class="text-danger">{{ $errors->first('ijazah_smp') }}</span>
                </div>
                <div class="form-group mt-1 mb-3">
                    <label for="ijazah_sma">Ijazah SMA (pdf/doc/docx)</label>
                    <input type="file" class="form-control @error('ijazah_sma') is-invalid @enderror" name="ijazah_sma">
                    <span class="text-danger">{{ $errors->first('ijazah_sma') }}</span>
                </div>
                <div class="form-group mt-1 mb-3">
                    <label for="ijazah_s1">Ijazah S1 (pdf/doc/docx)</label>
                    <input type="file" class="form-control @error('ijazah_s1') is-invalid @enderror" name="ijazah_sm1">
                    <span class="text-danger">{{ $errors->first('ijazah_s1') }}</span>
                </div>
                <div class="form-group mt-1 mb-3">
                    <label for="ijazah_s2">Ijazah S2 (pdf/doc/docx)</label>
                    <input type="file" class="form-control @error('ijazah_s2') is-invalid @enderror" name="ijazah_s2">
