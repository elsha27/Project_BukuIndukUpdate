@extends('layouts.app_sneat_user', ['title' => 'Detail Data Guru'])
@section('content')
    <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table width="100%">
                            <tbody>
                                <tr>
                                    <a href="{{ route('guru.foto', ['id' => $guru->id]) }}">
                                        <img src="{{ route('guru.foto', ['id' => $guru->id]) }}" alt="Foto Guru" class="img-thumbnail" style="width: 200px;">
                                    </a>
                                </tr>
                                <p></p>
                                <tr>
                        ...
                        <div class="d-flex justify-content-start">
                            <a href="{{ route('guru.edit', $guru->id) }}" class="btn btn-primary me-2">Edit</a>
                            <a href="{{ route('sk.create', $guru->id) }}" class="btn btn-success">Tambah SK</a>
                        </div>                        
                        <p></p>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Tombol Delete -->
                                        <form action="{{ route('sk.destroy', $sk->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
